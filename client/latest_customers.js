...
Template.latestCustomers.rendered = function() {
    Meteor.call("query", "select s.id, s.first_payment, s.next_payment, s.uid, s.pageid, u.firstname, u.lastname, u.email from stripe_subscriptions as s, users as u where s.canceled = 0 and u.uid=s.uid order by first_payment desc limit 10;", function(e, r) {
        if(e) {
            //error check
            console.log(e);
            return -1;
